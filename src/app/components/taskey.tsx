        ...
        <div className="container mx-auto flex px-5 py-12 md:py-24 flex-col md:flex-row items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-[#FFFFFF]">
              <span className='text-3xl md:text-5xl text-center ml-0 md:ml-[130px]'>Your work, everywhere you are</span>
            </h1>
            <p className="mb-8 leading-relaxed text-sm md:text-base text-[#FFFFFF] ml-0 md:ml-[130px] mt-[10px]">
            ...
            <button className="inline-flex w-[201px] mt-[30px] h-[63px] bg-[#4F9CF9] text-[#FFFFFF] items-center border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base ml-0 md:ml-[400px]">
